    ...
    # ── Любое другое сообщение ────────────────────────────────────────────────
        ...
        if booking.get("is_booking"):
            ...
            if name and service and time:
                ...
                return  # стоп — больше ничего не делаем
                ...
                bot.send_message(cid,
                    ...
                    reply_markup=cancel_menu())
                return
            # Если is_booking но нет данных — отвечаем через AI
            _ai_respond(cid, text)
        else:
            _ai_respond(cid, text)
...
if __name__ == "__main__":
    ...
    t.start()
    print("Bot started ✅")
    bot.polling(none_stop=True, interval=1)            bot.send_message(ADMIN_CHAT_ID, text)
        except Exception:
            pass
